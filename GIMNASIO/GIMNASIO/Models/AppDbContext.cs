...
namespace GIMNASIO.Models
{
    public class AppDbContext : IdentityDbContext<Cliente>
    {
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            optionsBuilder.UseSqlServer("workstation id=evolutiongymdatabase.mssql.somee.com;packet size=4096;user id=Charls_Sith_SQLLogin_1;pwd=vz272pu9uz;data source=evolutiongymdatabase.mssql.somee.com;persist security info=False;initial catalog=evolutiongymdatabase");
